...
def parse_args():
    ...
    parser.add_argument('img_dir', help='inference img dir')
...
def main():
    ...
    file_list = common.load_filepaths(img_dir, suffix=('.jpg', '.png', '.jpeg'), recursive=True)
    print(file_list[:10])
