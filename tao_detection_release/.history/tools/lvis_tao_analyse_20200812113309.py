...
def get_cate_gs():
    ...
    train_ann_file = './data/lvis/lvis_taocats_train.json'
    ...
    save_path = './data/lvis/lvis_taocats/tao_label2binlabel.pt'
    ...
    save_path = './data/lvis/lvis_taocats/tao_pred_slice_with0.pt'
    torch.save(savebin, save_path)
...
def get_split():
    ...
    train_ann_file = './data/lvis/lvis_taocats_train.json'
    val_ann_file = './data/lvis/lvis_taocats_val.json'
    ...
    split_file_name = './data/lvis/lvis_taocats/tao_valsplit.pkl'
