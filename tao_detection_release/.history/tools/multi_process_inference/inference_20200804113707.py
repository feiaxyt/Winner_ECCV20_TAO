...
def parse_args():
    ...
    parser.add_argument('--out_dir', type=str, default='./tmp/file/train_nonms_tta/', help='output dir')
...
def main():
    ...
    for i, data in enumerate(data_loader):
        ...
        save_name = file_path.replace('/home/songbai.xb/workspace/projects/TAO/data/TAO/frames/train/', '') 
