...
model = dict(
    ...
    interleaved=True,
    mask_info_flow=True,
    frozen_modules= ['backbone', 'neck', 'rpn_head'],
    backbone=dict(
        type='ResNeXt',
        depth=101,
        groups=64,
    ...
    bbox_head=[
        dict(
            ...
            gs_config=dict(
                label2binlabel='./data/lvis/lvis_taocats/tao_label2binlabel.pt',
                pred_slice='./data/lvis/lvis_taocats/tao_pred_slice_with0.pt',
                fg_split='./data/lvis/lvis_taocats/tao_valsplit.pkl',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/train_amend.json',
...
log_level = 'INFO'
work_dir = './work_dirs/gs_htc_dconv_c3-c5_mstrain_400_1400_x101_64x4d_fpn_1x_lvis_ft'
load_from = './data/pretrained_models/gs_htc_dconv_c3-c5_mstrain_400_1400_x101_64x4d_fpn_20e_lvis.pth'
resume_from = None
workflow = [('train', 1)]
