...
model = dict(
    ...
    bbox_head=[
        dict(
            ...
            gs_config=dict(
                label2binlabel='./data/lvis_v0.5/annotations/bags_v1/label2binlabel.pt',
                pred_slice='./data/lvis_v0.5/annotations/bags_v1/pred_slice_with0.pt',
                fg_split='./data/lvis_v0.5/annotations/bags_v1/valsplit.pkl',
