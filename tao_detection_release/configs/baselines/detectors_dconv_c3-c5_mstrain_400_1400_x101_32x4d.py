...
data_root = '/home/songbai.xb/workspace/research/detection/BalancedGroupSoftmax/data/lvis/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/detectors_sharing_dconv_c3-c5_mstrain_400_1400_x101_32x4d_fpn_20e_lvis'
load_from =  './data/pretrained_models/DetectoRS_X101-ed983634.pth'
resume_from = None
workflow = [('train', 1)]
